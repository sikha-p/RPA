...
@CommandPkg(
		...
		name = "soapWithWindowsTrustStore", label = "[[soapWithWindowsTrustStore.label]]",
		node_label = "[[soapWithWindowsTrustStore.node_label]]", description = "[[soapWithWindowsTrustStore.description]]", icon = "pkg.svg",
		
		//Return type information. return_type ensures only the right kind of variable is provided on the UI. 
		return_label = "[[soapWithWindowsTrustStore.return_label]]", return_type = STRING, return_required = true)
public class soapWithWindowsTrustStore {
//	private static final String CERT_TYPE = "X.509", TLS_VER = "TLSv1.2";
	...
	public Value<String> action(
		...
		SSLUtilityExp sslConfigurator = new SSLUtilityExp();
